                    ...
                    <div>
                        <div className="flex gap-16">
                            <div>
                                ...
                                <ul>
                                    <li><a href="/tags/web-design" className="hover:underline">Web Design</a></li>
                                    <li><a href="/tags/graphic-design" className="hover:underline">Graphic Design</a></li>
                                    <li><a href="/tags/logo" className="hover:underline">Logo</a></li>
                                    <li><a href="/tags/tech" className="hover:underline">About Tech</a></li>
                                </ul>
                            </div>
                            <div>
