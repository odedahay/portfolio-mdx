                    ...
                    <div>
                        <div className="flex gap-16">
                            <div>
                                ...
                                <ul>
                                    <li><a href="/tags/web-design" className="hover:underline">UX/UI Design</a></li>
                                    <li><a href="/tags/graphic-design" className="hover:underline">Front-End Development</a></li>
